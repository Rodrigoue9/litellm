...
//!
//! The route covers an allowlisted subset of requests. Anything outside it
//! returns [`crate::error::CoreError::Unsupported`] so a host that keeps the
//! Python implementation can fall back transparently instead of shipping a
//! translation the core cannot make faithfully.
